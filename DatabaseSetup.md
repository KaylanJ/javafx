# Statements needed to set up the database
Note these are not 100% complete / may be inaccurate to the actual database

### Below is the Create Table statements for the MariaDB database needed

#### Sets is the table of sets for you to ADD to the collection from, in a perfect world it would have every single lego set made.
...
#### Collection is the table for sets that are within your personal collection
...
#### Figures is all the figures that exists, which would be within a FigGroup in order to properly organize them into their respective sets
...
#### FigGroup is the table that organizes what figures should be in what sets
...
#### Genre organizes which genre or theme the set is connected to
